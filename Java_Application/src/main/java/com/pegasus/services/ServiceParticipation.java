...
import com.pegasus.entities.Participation;
...
public class ServiceParticipation {
    ...
    public boolean ajouter(Participation p) {
        ...
        com.pegasus.entities.Evenement event = serviceEvenement.getEvenementById(p.getId_evenement());
    ...
    public java.util.List<com.pegasus.entities.User> getParticipantsByEvenement(int eventId) {
        java.util.List<com.pegasus.entities.User> list = new java.util.ArrayList<>();
        ...
        try {
            ...
            while (rs.next()) {
                ...
                list.add(new com.pegasus.entities.User(
                    rs.getInt(1),

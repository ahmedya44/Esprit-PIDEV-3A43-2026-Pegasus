...
public class PaymentController {
    ...
    public void init(float montant, Runnable onSuccess) {
        ...
        labelTotal.setText(String.format("Total : %.2f EUR", montant));
    }
    ...
    public void handlePayer() {
        ...
        if (cardName.getText().isBlank() || cardNumber.getText().isBlank()
            ...
            showStatus("Veuillez remplir tous les champs.", "#e67e22");
            return;
        }
            ...
            try {
                ...
                Platform.runLater(() -> {
                    if (status.equals("requires_payment_method")
                        ...
                        showStatus("Paiement accepte avec succes !", "#27ae60");
                        btnPayer.setText("Paye");

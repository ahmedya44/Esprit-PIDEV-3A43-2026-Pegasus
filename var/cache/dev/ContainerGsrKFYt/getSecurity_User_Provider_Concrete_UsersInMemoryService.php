...
class getSecurity_User_Provider_Concrete_UsersInMemoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.user.provider.concrete.users_in_memory'] = new \Symfony\Component\Security\Core\User\InMemoryUserProvider(['artiste' => ['password' => '$2y$13$eXYQ5bXLmzaX1Z4xhp4xru6x7SFqCvzr3P/raNtiBEGhV1rp5MnbO', 'roles' => ['ROLE_ARTISTE']], 'user' => ['password' => '$2y$13$eXYQ5bXLmzaX1Z4xhp4xru6x7SFqCvzr3P/raNtiBEGhV1rp5MnbO', 'roles' => ['ROLE_USER']]]);
    }
}

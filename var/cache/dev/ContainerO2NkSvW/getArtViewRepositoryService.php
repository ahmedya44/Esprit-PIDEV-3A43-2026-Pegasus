 ...
 */
class getArtViewRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ArtViewRepository' shared autowired service.
     *
     * @return \App\Repository\ArtViewRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ArtViewRepository.php';

        return $container->privates['App\\Repository\\ArtViewRepository'] = new \App\Repository\ArtViewRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}

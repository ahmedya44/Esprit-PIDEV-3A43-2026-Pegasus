 ...
 */
class getArtRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ArtRepository' shared autowired service.
     *
     * @return \App\Repository\ArtRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ArtRepository.php';

        return $container->privates['App\\Repository\\ArtRepository'] = new \App\Repository\ArtRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}

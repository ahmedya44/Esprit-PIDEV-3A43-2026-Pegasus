 ...
 */
class getArtLikeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ArtLikeRepository' shared autowired service.
     *
     * @return \App\Repository\ArtLikeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ArtLikeRepository.php';

        return $container->privates['App\\Repository\\ArtLikeRepository'] = new \App\Repository\ArtLikeRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}

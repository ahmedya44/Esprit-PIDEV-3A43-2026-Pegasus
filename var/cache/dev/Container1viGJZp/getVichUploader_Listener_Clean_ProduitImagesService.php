 ...
 */
class getVichUploader_Listener_Clean_ProduitImagesService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.clean.produit_images' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.clean.produit_images'])) {
            return $container->privates['vich_uploader.listener.clean.produit_images'];
        }

        $instance = new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('produit_images', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? self::getVichUploader_MetadataReaderService($container)), $a);

        if (isset($container->privates['vich_uploader.listener.clean.produit_images'])) {
            return $container->privates['vich_uploader.listener.clean.produit_images'];
        }

        return $container->privates['vich_uploader.listener.clean.produit_images'] = $instance;
    }
}

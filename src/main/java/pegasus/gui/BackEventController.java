...
public class BackEventController {
    ...
    void ajouterEvenement(ActionEvent event) {
        ouvrirModalFormulaire("/ajouter-evenement.fxml", "Ajouter un Événement", null);
    }
    ...
    void modifierEvenement(ActionEvent event) {
        ...
        ouvrirModalFormulaire("/modifier-evenement-view.fxml", "Modifier l'Événement", selectedEvent);
    }
    ...
    void retourDashboard(ActionEvent event) throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/back-view.fxml"));

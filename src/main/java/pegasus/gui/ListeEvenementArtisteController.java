...
public class ListeEvenementArtisteController {
    ...
    private VBox createEventCard(Evenement e) {
        ...
        Button viewBtn = createIconButton("👁", "#6c5ce7");
        viewBtn.setOnAction(event -> allerVersDetails(e));

        Button editBtn = createIconButton("📝", "#00b894");
        editBtn.setOnAction(event -> allerVersModifier(e));

        Button deleteBtn = createIconButton("🗑", "#d63031");
        deleteBtn.setOnAction(event -> supprimerEvenement(e));

        Button participantsBtn = createIconButton("👥", "#0984e3");
    ...
    private void allerVersDetails(Evenement e) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/details-evenement-artiste.fxml"));
    ...
    void allerVersGestion(javafx.event.ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/ajouter-evenement.fxml"));
        Parent root = loader.load();

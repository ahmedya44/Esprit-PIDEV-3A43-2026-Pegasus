...
public class ListeEvenementSponsorController {
    ...
    private void filtrerEtAfficher() {
        ...
        if (filteredList.isEmpty()) {
            Label noMatch = new Label("Aucun événement à sponsoriser ne correspond à vos critères.");
    ...
    private void allerVersDetails(Evenement e) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/details-evenement-sponsor.fxml"));

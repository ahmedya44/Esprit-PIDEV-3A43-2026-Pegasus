...
public class BackController {
    ...
    void allerVersEvenements(ActionEvent event) {
        try {
            ...
            Parent root = FXMLLoader.load(getClass().getResource("/backevent-view.fxml"));
    ...
    void allerVersParticipants(ActionEvent event) {
        try {
            Node source = (Node) event.getSource();
            Stage stage = (Stage) source.getScene().getWindow();
            Parent root = FXMLLoader.load(getClass().getResource("/backparticipant-view.fxml"));
            stage.getScene().setRoot(root);
        } catch (IOException e) {
            e.printStackTrace();
    ...
    void allerVersSponsors(ActionEvent event) {
        try {
            Node source = (Node) event.getSource();
            Stage stage = (Stage) source.getScene().getWindow();
            Parent root = FXMLLoader.load(getClass().getResource("/backsponsor-view.fxml"));
            stage.getScene().setRoot(root);
        } catch (IOException e) {
            e.printStackTrace();

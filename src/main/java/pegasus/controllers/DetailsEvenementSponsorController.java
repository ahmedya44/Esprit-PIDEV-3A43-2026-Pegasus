...
public class DetailsEvenementSponsorController {
    ...
    void sponsoriser(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/reserver-pack-view.fxml"));
    ...
    void retourListe(ActionEvent event) throws IOException {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/views/liste-evenement-sponsor.fxml"));
        stage.getScene().setRoot(root);
    }
}

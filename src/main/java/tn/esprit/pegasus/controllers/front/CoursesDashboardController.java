...
public class CoursesDashboardController {
    ...
    private void openCourseSectionsWindow(Course course) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/front/CourseSectionsContent.fxml"));
    ...
    private void openQuizQuestionsWindow(Quiz quiz) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/front/QuizQuestionsContent.fxml"));
            Parent root = loader.load();
    ...
    private <T> TableCell<T, Integer> createIntegerCell() {

...
import tn.esprit.pegasus.services.CertificatePdfService;
...
import tn.esprit.pegasus.services.LearningInsightsService;
import tn.esprit.pegasus.services.QuizChoiceService;
import tn.esprit.pegasus.services.QuizQuestionService;
import tn.esprit.pegasus.services.QuizService;
import tn.esprit.pegasus.services.YouTubeVideoSummaryService;
...
public class CoursePlayerController implements FrontContentAware {
    ...
    private void submitQuiz() {
        ...
        lastQuizTimeSpentSeconds = calculateQuizTimeSpentSeconds();
        lastQuizTimeRemainingSeconds = calculateQuizTimeRemainingSeconds(lastQuizTimeSpentSeconds);
        btnSubmitQuiz.setDisable(true);
        disableQuizInputs();

        if (percentage >= courseQuiz.getPassingScore()) {

...
public class RecommendationService {
    ...
    public List<Art> getSimilarArtworks(int artworkId, int limit) {
        try {
            ...
            System.out.println("Total d'œuvres disponibles: " + allArtworks.size());
            ...
            for (Art art : allArtworks) {
                if (art.getId() != artworkId) {
                    ...
                    if (score >= 0.7) { // Seuil TRÈS strict - minimum 70% de similarité
                        ...
                        System.out.println("Ajouté aux recommandations!");
                    } else {
            ...
            System.out.println("Recommandations trouvées: " + scoredRecommendations.size());
            
            // Si aucune recommandation n'est trouvée, prendre les œuvres les plus populaires
            if (scoredRecommendations.isEmpty()) {
                System.out.println("Aucune recommandation trouvée, utilisation des œuvres populaires...");
                ...
                System.out.println("Œuvres populaires sélectionnées: " + popularArtworks.size());
    ...
    private double calculateSimilarityScore(Art art1, Art art2) {
        ...
        if (art1.getArtist() != null && art2.getArtist() != null) {
            ...
            if (artist1.equals(artist2)) {
                ...
                System.out.println("Même artiste: " + art1.getArtist());
            } else {
                score = 0.0; // 0% si artiste différent
                System.out.println("Artistes différents: " + art1.getArtist() + " != " + art2.getArtist());
            }
        } else {

...
import com.pegasus.entities.Commande;
import com.pegasus.entities.LigneCommande;
...
public class TicketPdfService {
    ...
    public static String genererTicket(Commande commande, List<LigneCommande> lignes, String clientNom) {

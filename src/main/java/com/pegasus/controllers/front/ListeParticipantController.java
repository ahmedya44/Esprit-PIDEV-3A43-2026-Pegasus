...
public class ListeParticipantController extends FrontNavController {
    ...
    private void allerVersDetails(Evenement e) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/front/details-evenement-participant.fxml"));
